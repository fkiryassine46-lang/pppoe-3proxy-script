...
#    >>> MISE A JOUR: WHITELIST (4 sites) + BLOCK ALL
############################################
...
# Allow ONLY these sites (HTTP/HTTPS)
allow * * whatsmyip.com,www.whatsmyip.com 80,443 HTTP,CONNECT
allow * * blsspainmorocco.net,*.blsspainmorocco.net 80,443 HTTP,CONNECT
allow * * visas-fr.tlscontact.com,*.tlscontact.com 80,443 HTTP,CONNECT
allow * * visa.vfsglobal.com,*.vfsglobal.com 80,443 HTTP,CONNECT
